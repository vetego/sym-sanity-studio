...
export class DatasetImportCommand extends SanityCommand {
    ...
    async run() {
        ...
        const { project: projectId, dataset, token, replace, missing, 'allow-failing-assets': allowFailingAssets, 'allow-assets-in-different-dataset': allowAssetsInDifferentDataset, 'replace-assets': replaceAssets, 'skip-cross-dataset-references': skipCrossDatasetReferences, 'allow-system-documents': allowSystemDocuments, 'asset-concurrency': assetConcurrency } = flags;
        const { source } = args;
