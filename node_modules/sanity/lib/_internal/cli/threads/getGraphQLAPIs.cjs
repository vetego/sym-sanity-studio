"use strict";
var node_worker_threads = require("node:worker_threads"), lodashEs = require("lodash-es"), oneline = require("oneline"), getStudioWorkspaces = require("../../../_chunks-cjs/getStudioWorkspaces.cjs");
...
function isPlainishObject(input) {
  return lodashEs.isPlainObject(input);
}
